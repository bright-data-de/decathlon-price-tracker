...
Info  : https://brightdata.de/products/insights/price-tracker/decathlon
"""
...
# https://brightdata.de/products/web-scraper/decathlon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Decathlon scraper at: https://brightdata.de/products/web-scraper/decathlon\n"
